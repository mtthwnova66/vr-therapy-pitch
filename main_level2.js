...
function initLevel2() {
  ...
  try {
    ...
    // --------------------------------------------------------------------
    // The main photorealistic scene objects (table, jar, lid, spider, dust) are grouped in mainScene and are initially hidden.
    let vrHeadset;
    ...
    // Update the VR headset entrance animation between phases (copied exactly)
    ...
    // Easing function for smooth animation (copied exactly)
    ...
    function createTable() {
      ...
      // For a table with top at y=0.6, center at y=0.5.
    ...
    function loadSpiderModel() {
      ...
      gltfLoader.load(
        ...
        function(gltf) {
          ...
          // Compute offset so that the spider’s lowest point aligns with the table top at y=0.6.
          ...
          // Aim the spotlight at the spider.
