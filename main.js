...
window.initLevel1 = function() {
  ...
  // Play the Level 1 voice recording immediately when this function is invoked.
  const level1Audio = new Audio('recordinglevel1.mp3');
  level1Audio.play().catch(error => console.error("Error playing level 1 audio:", error));
